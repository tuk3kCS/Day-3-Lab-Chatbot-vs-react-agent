...
* *Booking Tool:* Đặt vé vui chơi, đặt phòng Vinpearl, đặt nhà hàng.

* *Itinerary Planner Tool:* Tự động lên lịch trình cá nhân hóa tại các công viên (VinWonders Nha Trang, Phú Quốc, Nam Hội An...), đặt lịch nhà hàng, khách sạn,...

* *Park Navigation & Info Tool:* Tra cứu bản đồ, vị trí nhà vệ sinh, ATM, lịch biểu diễn (Tata Show, nhạc nước...).

* *Promotion & Loyalty Tool:* Tra cứu mã giảm giá, tích điểm Pearl Club.
...
* **Hạn chế & Điểm nghẽn:**
    ...
    * *Thiếu tính tức thời:* Việc mô tả vị trí bằng text (ví dụ: "Đi qua khu cổ tích, rẽ trái ở nhà hàng...") gây nhầm lẫn lớn cho du khách chưa quen sơ đồ công viên.
...
* **Mô tả kỹ thuật:** Kết hợp sức mạnh hiểu ngữ cảnh của Generative AI với giao diện thành phần tương tác trực quan (Interactive UI Components như Cards, Maps, Forms găm sẵn).
    ...
    * *Đối với Báo mất đồ khẩn cấp:* AI tự động hiển thị một **Quick Form** (Form khai báo nhanh dạng Hybrid đè lên giao diện chat) để user chọn nhanh loại đồ vật, chụp hình/tải ảnh lên và định vị vị trí hiện tại chỉ với 1 chạm.
* **Cải tiến vượt trội (Rationale):**
    * Giảm 70% số lượng text không cần thiết trên màn hình.
    * Rút ngắn thời gian xử lý một ca báo khẩn cấp từ 3 phút xuống còn dưới 45 giây.
